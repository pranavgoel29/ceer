    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-50 w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-hidden rounded-3xl bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/5 dark:ring-foreground/10",
        ...
        >
          {alignItemWithTrigger ? (
            ...
            <SelectPrimitive.List className="max-h-60 overflow-y-auto overscroll-contain p-1.5 scroll-smooth">
              {children}
